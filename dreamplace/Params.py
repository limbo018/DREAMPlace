...
class Params:
    ...
    def __init__(self):
        ...
        self.deterministic_flag = False # whether force run-to-run determinism 
...
deterministic_flag [default %d] | whether force run-to-run determinism
        """ % (self.gpu, 
                self.num_bins_x, 
                self.num_bins_y, 
                self.target_density, 
    ...
    def toJson(self):
        ...
        data['deterministic_flag'] = self.deterministic_flag
        return data 
    ...
    def fromJson(self, data):
        ...
        if 'deterministic_flag' in data: self.deterministic_flag = data['deterministic_flag']
