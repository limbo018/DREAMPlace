...
//#pragma omp parallel for schedule(dynamic, 1)
        ...
        printf("[I] iteration %d, target hpwl %g, delta %g(%g%%), solved %d sets, moved %g%% cells, runtime %g ms\n", 
                iter, 
        ...
        printf("[D] %s takes %g ms, %d runs, average %g ms\n", 
                solver.name(), 
                get_timer_period()*hungarian_time, hungarian_runs, get_timer_period()*hungarian_time/hungarian_runs);
        printf("[D] apply solution takes %g ms, %d runs, average %g ms\n", 
