/*
 * @file   weighted_average_wirelength_cuda_reduce.cpp
 * @author Xiaohan Gao
 * @date   Aug 2019
 */
        ...
        at::Tensor inv_gamma) 
{
    ...
    DREAMPLACE_DISPATCH_FLOATING_TYPES(pos.type(), "computeWeightedAverageWirelengthCudaReduceLauncher", [&] {
            computeWeightedAverageWirelengthCudaReduceLauncher<scalar_t, V>(
...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
  m.def("forward", &DREAMPLACE_NAMESPACE::weighted_average_wirelength_reduce_forward, "WeightedAverageWirelength forward (CUDA)");
  m.def("backward", &DREAMPLACE_NAMESPACE::weighted_average_wirelength_reduce_backward, "WeightedAverageWirelength backward (CUDA)");
}
