...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
  m.def("forward", &weighted_average_wirelength_atomic_forward, "WeightedAverageWirelength forward (CUDA)");
  m.def("backward", &weighted_average_wirelength_atomic_backward, "WeightedAverageWirelength backward (CUDA)");
}
