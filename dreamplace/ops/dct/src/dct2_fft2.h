...
void idct2_fft2PreprocessCpuLauncher(
            ...
            int num_threads)
{
    idct2_fft2PreprocessCpu<T, ComplexType<T>>(x, (ComplexType<T>*)y, M, N, (ComplexType<T>*)expkM, (ComplexType<T>*)expkN);
}
...
template <typename T>
idct_idxstPreprocessCpuLauncher(
            const T* x,
            T* y,
            const int M,
            const int N,
...
template <typename T>
idct_idxstPostprocessCpuLauncher(
            const T* x,
            T* y,
            const int M,
            const int N,
...
template <typename T>
idxst_idctPreprocessCpuLauncher(
            const T* x,
            T* y,
            const int M,
            const int N,
...
template <typename T>
idxst_idctPostprocessCpuLauncher(
            const T* x,
            T* y,
            const int M,
            const int N,
