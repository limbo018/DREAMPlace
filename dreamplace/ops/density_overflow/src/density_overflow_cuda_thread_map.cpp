        ...
        ) 
{
    ...
    AT_DISPATCH_FLOATING_TYPES(pos.type().scalarType(), "computeDensityOverflowMapCudaThreadMapLauncher", [&] {
        ...
        ) 
{
    ...
    {
        // Call the cuda kernel launcher
        AT_DISPATCH_FLOATING_TYPES(pos.type().scalarType(), "computeDensityOverflowMapCudaLauncher", [&] {
        ...
        )
{
    ...
    AT_DISPATCH_FLOATING_TYPES(node_size_x.type().scalarType(), "thread_count", [&] {
    ...
    AT_DISPATCH_FLOATING_TYPES(node_size_x.type().scalarType(), "thread_map", [&] {
            auto node_size_x_accessor = node_size_x.accessor<scalar_t, 1>(); 
            auto node_size_y_accessor = node_size_x.accessor<scalar_t, 1>(); 
