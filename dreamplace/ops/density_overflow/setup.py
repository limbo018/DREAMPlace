...
setup(
        ...
        ext_modules=[
            ...
            CUDAExtension('density_overflow_cuda_thread_map', 
                [
                    'src/density_overflow_cuda_thread_map.cpp',
                    'src/density_overflow_cuda_kernel.cu', 
                    'src/density_overflow_cuda_thread_map_kernel.cu'
                    ], 
                include_dirs=include_dirs, 
                library_dirs=lib_dirs,
            ...
            CUDAExtension('density_overflow_cuda_by_node', 
                [
                    'src/density_overflow_cuda_by_node.cpp',
                    'src/density_overflow_cuda_by_node_kernel.cu'
                    ], 
                include_dirs=include_dirs, 
                library_dirs=lib_dirs,
                libraries=['cusparse', 'culibos'] + libs,
