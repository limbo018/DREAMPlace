        ...
        )
{
    ...
    db.flat_net2pin_start_map = DREAMPLACE_TENSOR_DATA_PTR(flat_net2pin_start_map, int); 
    ...
    db.flat_node2pin_start_map = DREAMPLACE_TENSOR_DATA_PTR(flat_node2pin_start_map, int); 
