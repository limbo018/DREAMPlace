...
class NesterovAcceleratedGradientOptimizer(Optimizer):
    ...
    def step(self, closure=None, joint_opt=False):
        """
        ...
        for group in self.param_groups:
            ...
            for i, p in enumerate(group['params']):
                ...
                if not group['u_k']:
                    ...
                    group['v_k'].append(p)
                    obj, grad = obj_and_grad_fn(group['v_k'][i], joint_opt=joint_opt)
                ...
                if not group['a_k']:
                    ...
                    obj, grad = obj_and_grad_fn(group['v_k_1'][i], joint_opt=joint_opt)
                ...
                while True:
                    ...
                    f_kp1, g_kp1 = obj_and_grad_fn(v_kp1, joint_opt=joint_opt)
